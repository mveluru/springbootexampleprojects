...
- `org.bee.banking` — client/account registration, withdraw/deposit, bank statements, async notifications, Resilience4j payment demo, plus a `Filter`-based API gateway/rate limiter (`org.bee.banking.gateway`) fronting the whole module
