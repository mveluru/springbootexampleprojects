...
seeds demo accounts on first start. They exist to build/inspect/reset the database by hand.

| Directory | File | What it does |
|---|---|---|
| `ddl/` | `01_create_tables.sql` | `CREATE DATABASE` + all 5 tables, unique index and foreign keys |
